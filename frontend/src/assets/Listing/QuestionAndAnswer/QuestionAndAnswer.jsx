...
function QuestionAndAnswer() {
    const [questions, setQuestions] = useState(["How many kms does it have on the clock? Also how many owners has it had?", "Will you accept $3500?" ]);
    ...
    <div className={styles.content}>
      ...
      <div className={styles.questionAnswerConstainer}>
